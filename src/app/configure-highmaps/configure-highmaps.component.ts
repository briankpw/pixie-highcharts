...
// import { PixieHighchartsLocaleService } from 'pixie-highcharts';

@Component({
  selector: 'pixie-configure-highmaps',
  templateUrl: './configure-highmaps.component.html',
  styleUrls: ['./configure-highmaps.component.css']
})
export class ConfigureHighmapsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formGroupChart.controls['localeModel'].valueChanges.subscribe(d => {
      // PixieHighchartsLocaleService.setLocale(d);
    });
  }
